...
function sidebarToggle(){
	...
	document.getElementById("sidebar").innerHTML = '<div id="sidebarContent"><center>
	<p class="sidebarText1">About</p><a href="index.html" 
	class="sidebarItem" id="sidebarLinkContact">TSA</a>
	...
	<p class="sidebarText1">Artifical Intellegence</p>
		<a href="tech.html" class="sidebarItem" id="sidebarLinkGolf">Available Technology</a>
		<a href="future.html" class="sidebarItem" id="sidebarLinkGolf">Future Technology</a>
		<a href="safety.html" class="sidebarItem" id="sidebarLinkRich">Safety Concerns</a>
		<a href="cited.html" class="sidebarItem" id="sidebarLinkCodeMagic">Works Cited</a><center>
	</div>';
